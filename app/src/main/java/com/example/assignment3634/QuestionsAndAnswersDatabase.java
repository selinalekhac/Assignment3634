...
public class QuestionsAndAnswersDatabase {
    ...
    static {
        questions.put(1, new Questions(
                1,
                "Jamie went to the zoo to see his favourite animals. He has been looking" +
                        "forward to see the koalas as he has never seen them before. However, for the duration of" +
                        "his stay at the zoo the koalas were all a sleep.",
        ...
        questions.put(2, new Questions(
                2,
                "Johnson just moved half way across Australia because his parents got promoted" +
                        "he is just about to start his first day of Year 8. He had a lot of friends back home, " +
                        "however he is quite the social butterfly when he is in the mood. He loves this town  he " +
                        "has moved to as he has visited this town prior",
        ...
        questions.put(5, new Questions(
                ...
                "What do you think Sarah is feeling as the bus driver announced that the bus had broken down?",
                "Panicked",
                "Anxious",
                "Overwhelmed",
                "Stressed"
